...
export default function LpSignUpFormView({ onNext }: Props) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto py-8 px-8 bg-white">
      ...
      <div className="mt-10">
        <GoogleLoginButton
          isLogin={false}
          disabled={!googleTermsAccepted || !googlePrivacyAccepted}
        />
      </div>
    </div>
  )

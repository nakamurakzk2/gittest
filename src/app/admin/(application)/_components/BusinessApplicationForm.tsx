...
export default function BusinessApplicationForm() {
  ...
  }, [isValidEmail, name, password, confirmPassword, phoneNumber, businessName, townId])
  ...
  const onClickSubmit = async () => {
    ...
    await onFetch(async () => {
      await AdminApplicationServerLogic.applyBusiness(email, name, phoneNumber, townId, businessName, password)
      toast({
        title: "お知らせ",
        description: "事業者アカウントの申請が完了しました",
        duration: 3000
      })
      resetForm()
    })
    ...
    <main className="max-w-2xl mx-auto px-4 py-6">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">事業者アカウント作成</CardTitle>
          <CardDescription>
            事業者アカウントを作成します。すべての項目を入力して申請してください。
          </CardDescription>
        </CardHeader>
